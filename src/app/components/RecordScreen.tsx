...
const Record: React.FC<RecordProps> = ({ question }) => {
  const [mode, setMode] = useState("default"); // Modes: 'video', 'text', 'voice'
  ...
  return (
    <div className="flex h-96 w-full max-w-4xl flex-row overflow-hidden rounded-lg border-2 border-black bg-gray-200">
      ...
      <div className="relative flex w-full items-end bg-red-50">
        <Image
          src="/image.png" // Assuming the image is in the public directory
          alt="Voice call"
          layout="fill" // This makes the image fill the container
          objectFit="cover" // This ensures the image covers the full area, cropping if necessary
